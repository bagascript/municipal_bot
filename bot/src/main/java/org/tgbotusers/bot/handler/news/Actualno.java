...
import org.tgbotusers.bot.text.actualno.ActualnoText;
...
public class Actualno implements ActualnoText {
    ...
    private InlineKeyboardMarkup inlineKeyboardSectionNewsButton() {
        news1.setCallbackData("/actualnoNews1");
        news2.setCallbackData("/actualnoNews2");
        news3.setCallbackData("/actualnoNews3");
        news4.setCallbackData("/actualnoNews4");
        news5.setCallbackData("/actualnoNews5");
    ...
    private InlineKeyboardMarkup inlineKeyboardOpekaNewsButton() {
        PREVIOUS_BUTTON.setCallbackData("/latNews");
    ...
    public void sendActualnoNews1(long chatId) {
        SendMessage message = new SendMessage();
        message.setChatId(chatId);
    ...
    public void sendActualnoNews2(long chatId) {
        SendMessage message = new SendMessage();
        message.setChatId(chatId);
    ...
    public void sendActualnoNews3(long chatId) {
        SendMessage message = new SendMessage();
        message.setChatId(chatId);
    ...
    public void sendActualnoNews4(long chatId) {
        SendMessage message = new SendMessage();
        message.setChatId(chatId);
    ...
    public void sendActualnoNews5(long chatId) {
        SendMessage message = new SendMessage();
        message.setChatId(chatId);
    ...
    public void getSendSelectionActualnoNewsMenu(long chatId) {
